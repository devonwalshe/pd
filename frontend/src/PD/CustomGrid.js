        ...
        return (
            <div style={{ fontSize: '13px', fontFamily: 'Verdana', float: 'left' }}>
                <JqxGrid ref={this.myGrid} onSort={this.myGridOnSort}
                    // @ts-ignore
                    width={getWidth('grid')} height={450} source={this.state.source} columns={this.state.columns}
                ...
                <div style={{ marginTop: '30px' }}>
                    <div style={{ float: 'left', marginRight: '10px' }}>
                        ...
                        <JqxCheckBox onChange={this.sortBackGroundBtn} height={25} checked={true}>Sort Background</JqxCheckBox>
                    </div>
