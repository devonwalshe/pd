    ...
    render() {
        return (
            <>
                ...
                <div style={{alignItems:'center',display:'flex',float:'left'}}>
                    <Button variant="outline-primary" onClick={() => this.props.sectionGo(-1,true, this.state.features_filter)} >&lt;&lt;</Button>
                    <Button variant="outline-primary" onClick={() => this.props.sectionGo(-1,false, this.state.features_filter)}>&lt;</Button>
