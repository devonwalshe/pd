...
class WeldMatcher(object):
  ...
  def __init__(self, w1, w2, coord_match=False):
    self.matched_welds = self.match_welds(w1, w2, coord_match)
    
  def match_welds(self, w1, w2, coord_match):
    if coord_match:
      matched_welds = coord_match(w1,w2)
    else:
      matched_welds = backtrack_match
    
    
  def coord_match(self, w1, w2):
    pass
  
  def backtrack_match(self, w1,w2):
    pass
    
  def backtrack_match(w1, w1):
    '''
